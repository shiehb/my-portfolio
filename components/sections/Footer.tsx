...
export function Footer() {
  ...
  return (
    <footer
      id="site-footer"
      className="w-full min-h-dvh border-t border-white/5 bg-transparent px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 text-center flex flex-col items-center justify-center relative"
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-3">
        ...
        <p className="text-xs sm:text-sm font-mono text-ink-500 tracking-wider">
