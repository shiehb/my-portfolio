    ...
    return (
        <>
            ...
            <header className="bg-transparent fixed top-0 inset-x-0 z-50 pointer-events-none py-6 sm:py-8">
                <div className="w-full max-w-[1920px] mx-auto flex items-center justify-between gap-6  px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-20 pointer-events-auto">
                    <Link
                        href="/"
                        onClick={(e) => {
                            e.preventDefault();
